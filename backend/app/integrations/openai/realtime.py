...
result includes an active route context, preserve that exact opaque value for
the later reroute call; never invent or substitute a context value.
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "active_route_context": {
                    "type": "string",
                    "description": "The exact opaque context returned with the selected search result; never invent one.",
                },
                "confirmation": {
                    "type": "string",
                    "enum": ["confirmed"],
            ...
            "required": ["poi_id", "active_route_context", "confirmation"],
            "additionalProperties": False,
        },
    },
]
